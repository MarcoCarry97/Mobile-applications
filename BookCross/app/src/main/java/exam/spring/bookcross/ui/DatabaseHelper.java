...
{
    public static final String NAME="searches.db";
    ...
    private static final String CREATE=String.format(" create table %s (%s integer primary key autoincrement, %s text not null, %s text not null, %s long not null);",TABLE,DatabaseContract.ID,DatabaseContract.BOOK,DatabaseContract.IMAGE,DatabaseContract.DATE);
